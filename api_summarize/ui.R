                    ...
                    fluidPage(
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          p("- You can a) specify the date and original report receive date/on-set date to query the Animal Adverse Effect API and obtain the corresponding data.  b) specify the date range to query the Food Enforcement data.  c) query by animal species and date to return the animal adverse events. d) The observation numbers from 1 to 1000 due to the limit of each query."),
